...
public class TextViewRichDrawable extends AppCompatTextView implements DrawableEnriched {
    ...
    public RichDrawableHelper getmRichDrawableHelper() {
        return mRichDrawableHelper;
    }

    public void setmRichDrawableHelper(RichDrawableHelper mRichDrawableHelper) {
        this.mRichDrawableHelper = mRichDrawableHelper;
    }
